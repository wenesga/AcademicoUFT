...
\instituicao{%
  Universidade Federal do Tocantins \par
  Campus Universitário de Palmas \par
  Curso de Licenciatura em Computação \par}
...
\chapter{Suspendisse vel felis Praesent enim elit}
...
\chapter{Imprime uma página indicando o início dos apêndices Gera texto de exemplo preencher página}
...
\chapter{Gera texto de exemplo para preencher a página Quisque facilisis auctor sapien}
